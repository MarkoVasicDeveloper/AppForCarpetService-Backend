...
export class CarpetReceprionController {
  constructor(
    private readonly carpetReceptionService: CarpetReceptionsService
  ) {}
  ...
  async editCarpetReception(
    ...
    return await this.carpetReceptionService.editCarpetReception(
      data,
      workerId,
      userId
    );
  ...
  async getAllReceptionsByClient(
    ...
    return await this.carpetReceptionService.getAllReceptionByuser(
      clientsId,
      userId
    );
  }
